...
// https://www.jqueryscript.net/gallery/Gallery-Content-Filter-With-jQuery-CSS3.html
...
<!-- <div class="imgal-container gallery">

    <?php
    // $con = mysqli_connect('127.0.0.1', 'root', '', 'furns');
    // $res = mysqli_query ($con, 'SELECT * FROM movel');
    // while ($movel = mysqli_fetch_assoc($res)):?>
    <a href="#" class="<?php// echo $movel['estilo']." ".$movel['categoria']." ".$movel['subcategoria'];?>">
    <img src="<?php// echo $movel['imagem']; ?>" class="imgal-img" alt="<?php// echo $movel['nome'];?>"></a>
