<!-- <?php $con= conecta(); // $res=m ysqli_query ($con, 'SELECT * FROM movel'); ?> -->
...
>>>>>>> ef09501d79a9de27a7495a66d8204e6227d74d7a
			...
			<div class="row">
				...
				<div class="col-md">
					<input type="" name="" value="Alterar" class="form-control bg-warning border-warning">
				</div>
				<div class="col-md">
					<input type="" name="" value="Excluir" class="form-control bg-warning border-warning">
				</div>
			</div>
